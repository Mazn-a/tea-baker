...
(function (global) {
  const catalog = {
    ...
    /**
     * تقييمات العملاء — عدّل هنا فقط.
     * الأفضل: عبارة حقيقية + مدينة + نوع مناسبة + شهر قريب.
     * لا تخترع عدد تقييمات أو تقييم قوقل.
     */
    reviews: [
      {
        ...
        event: "زواج",
        pkg: "البكج الذهبي",
        when: "ربيع الآخر 1447",
        featured: true,
        text: "كنت خايف الطلب أونلاين يضيع. طلبت من الموقع ووصلني واتساب على رقمي في نفس اليوم، والسعر نفس اللي مكتوب في البكج.",
      },
      {
        name: "نورة الزهراني",
        city: "جدة",
        event: "ملكة",
        pkg: "البكج الفضي",
        when: "جمادى الأولى 1447",
        text: "الركن انجهز قبل دخول الضيوف، والمباشرين بزي رسمي. ما صار تأخير ولا ناقص من الاتفاق.",
      },
      {
        name: "فيصل الحربي",
        city: "الطائف",
        ...
        pkg: "البكج الملكي",
        when: "رجب 1447",
        text: "البكج الملكي كفى العدد. القهوة والتمر ما انقطعت، وما دفعت شيء من الموقع — العربون بعد ما قبلوا الموعد.",
      },
    ],
