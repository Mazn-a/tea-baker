...
(function (global) {
  const catalog = {
    ...
    /**
     * تقييمات العملاء — عدّل النص أو الاسم هنا فقط.
     * استبدل أي تقييم بعبارة عميل حقيقي متى توفّرت.
     */
    reviews: [
      {
        ...
        event: "زواج",
        stars: 5,
        text: "الركن مرتّب والمباشرين بزي رسمي. الضيوف سألوا عن الشاي أكثر من مرة، والاتفاق كان واضح من أول رسالة.",
      },
      {
        name: "نورة الزهراني",
        city: "جدة",
        event: "ملكة",
        stars: 5,
        text: "طلبت من الموقع ووصلني واتساب في نفس اليوم. السعر نفس اللي ظاهر في البكج، بدون مفاجآت بعد القبول.",
      },
      {
        name: "فيصل الحربي",
        city: "الطائف",
        event: "زواج",
        stars: 5,
        text: "البكج الذهبي كفى العدد اللي اتفقنا عليه. القهوة والتمر ما انقطعت، والركن انجهز قبل دخول الضيوف.",
      },
      {
        name: "سارة المالكي",
        city: "مكة المكرمة",
        event: "زواج",
        stars: 5,
        text: "كنت مترددة لأن أول مرة أحجز ضيافة من موقع. طلع محل معروف في الراشدية، والتأكيد وصل على جوالي.",
      },
    ],
